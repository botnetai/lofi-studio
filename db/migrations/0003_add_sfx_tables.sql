...
-- COMMENTED OUT FOR MVP - SFX moved to LATER section of migration plan
...
-- IMPORTANT: Replace the r2_url values below with your actual R2 public URLs after uploading files
-- INSERT INTO public.sfx_effects (name, display_name, category, description, r2_key, r2_url, duration_seconds, default_gain) VALUES
--   ('rain_light', 'Light Rain', 'weather', 'Gentle rain falling on leaves', 'sfx/rain_light.mp3', 'https://placeholder-r2-url/sfx/rain_light.mp3', 120, 0.4),
--   ('rain_heavy', 'Heavy Rain', 'weather', 'Heavy rain with thunder in background', 'sfx/rain_heavy.mp3', 'https://placeholder-r2-url/sfx/rain_heavy.mp3', 180, 0.5),
--   ('forest_birds', 'Forest Birds', 'nature', 'Various bird calls in a forest', 'sfx/forest_birds.mp3', 'https://placeholder-r2-url/sfx/forest_birds.mp3', 240, 0.3),
--   ('ocean_waves', 'Ocean Waves', 'nature', 'Gentle ocean waves on beach', 'sfx/ocean_waves.mp3', 'https://placeholder-r2-url/sfx/ocean_waves.mp3', 200, 0.4),
--   ('wind_gentle', 'Gentle Wind', 'weather', 'Soft wind through trees', 'sfx/wind_gentle.mp3', 'https://placeholder-r2-url/sfx/wind_gentle.mp3', 150, 0.2),
--   ('crackling_fire', 'Crackling Fire', 'ambience', 'Cozy fireplace crackling', 'sfx/crackling_fire.mp3', 'https://placeholder-r2-url/sfx/crackling_fire.mp3', 160, 0.6),
--   ('cafe_ambience', 'Cafe Ambience', 'urban', 'Coffee shop background noise', 'sfx/cafe_ambience.mp3', 'https://placeholder-r2-url/sfx/cafe_ambience.mp3', 300, 0.3),
--   ('city_traffic', 'City Traffic', 'urban', 'Distant city traffic sounds', 'sfx/city_traffic.mp3', 'https://placeholder-r2-url/sfx/city_traffic.mp3', 180, 0.2),
--   ('thunder_storm', 'Thunder Storm', 'weather', 'Distant thunder and heavy rain', 'sfx/thunder_storm.mp3', 'https://placeholder-r2-url/sfx/thunder_storm.mp3', 220, 0.4),
--   ('night_crickets', 'Night Crickets', 'nature', 'Crickets chirping at night', 'sfx/night_crickets.mp3', 'https://placeholder-r2-url/sfx/night_crickets.mp3', 280, 0.3);
